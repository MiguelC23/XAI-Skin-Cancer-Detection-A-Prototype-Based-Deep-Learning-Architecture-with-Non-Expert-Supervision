...
def find_k_nearest_patches_to_prototypes(dataloader: DataLoader,
    ...
    n_malignant_prototypes=prototype_network_parallel.module.num_malignant_prototypes
    prototype_shape = prototype_network_parallel.module.prototype_shape
    max_dist = prototype_shape[1] * prototype_shape[2] * prototype_shape[3]
    protoL_rf_info = prototype_network_parallel.module.proto_layer_rf_info

    heaps = []
    # allocate an array of n_malignant_prototypes number of heaps
    for _ in range(n_malignant_prototypes):
    ...
    for idx, data in enumerate(dataloader):
        ...
        for img_idx, distance_map in enumerate(proto_dist_):
            for j in range(n_malignant_prototypes):
    ...
    #     [[patch.label for patch in heaps[j]] for j in range(n_malignant_prototypes)])
