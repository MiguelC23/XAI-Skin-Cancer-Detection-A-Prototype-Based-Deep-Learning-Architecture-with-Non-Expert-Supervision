if __name__ == '__main__':
    ...
    import random
    from Dataset import ISIC2019_Dataset,PH2_Dataset_or_Derm7pt_for_remove_pixels
    ...
    path_to_one_model=r"C:\ACP_BM_Problem\NC2\resnet18\run1\20_2push0.8295.pth"
    ...
    log("\n========================Performance========================\n")
    accu_test,F1_score_test,ba_test,bas_p_test,percentagens_test = tnt.test(model=ppnet_multi, dataloader=test_loader,coefs=coefs,log=log, weights=weights,
                                                            ...
                                                            heatmap_random=RANDOM_HEAT_MAPS)
