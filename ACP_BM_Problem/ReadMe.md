...
If PH2=False and the model was trained with 8 classes, set FLAG_MODEL_TRAINED_WITH_8_CLASSES_AND_TEST_DERM7PT=True and FLAG_MODEL_TRAINED_WITH_8_CLASSES_AND_TEST_PH2=False.
    ...
    if(PH2==True):
        ...
        folder=r"...\ACP_BM_PROBLEM\PH2_Results" #Path to the folder where a text file with the results will be saved.
    else:
        test_dir=r"...Path to the folder containing the class folders of the test images from the Derm7pt dataset..."
        folder="...\ACP_BM_PROBLEM\Derm7pt_Results"#Path to the folder where a text file with the results will be saved.
    ...
    ...
    if(PH2==True):
        ...
        test_mask_dir=r"..."  Path to the folder where six folders are located,(BCC, BKL, DF, MEL, NV, VASC), i.e., the binary masks where 1 represents the non-relevant and 0 represents the relevant. 
        #One binary mask per image. 
...
## 14-Perform an analysis of the concepts that a prototype may be triggering/activating using the information from the top-k patches of EDEASD closest to that prototype. 
