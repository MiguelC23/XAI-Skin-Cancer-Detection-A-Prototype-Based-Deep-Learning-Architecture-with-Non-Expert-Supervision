...
number_of_prototypes_per_class=3#Choose the number of prototypes for each class.
...
LP1C_MASKED=False #Put True to Use masks in the internal structure of the model, i.e in the forward process to disregard patches that are not relevant.
